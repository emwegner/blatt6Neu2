package com.example.blatt6neu2;
                    ...
                    if (spielfeld.felder[cell1][cell2].isMine()) {
                        for (int i = 0; i < spielfeld.felder.length; i++) {
                            for (int j = 0; j < spielfeld.felder[i].length; j++) {
                                ...
                                if (spielfeld.felder[i][j].isMine())
                                    tempe.setBackground(getResources().getDrawable(R.drawable.feld_bomb));
...
*/
    ...
    private void intizialize() {
        ...
        textview.setText(Integer.toString(spielfeld.getAnzahlBomben()));
